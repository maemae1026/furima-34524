class BuyerResidence
  ...
  def save
    ...
    Residence.create(postal_code: postal_code, prefecture: prefecture, prefecture_id: prefecture_id, city: city, house_number: house_number, building_name: building_name, phone_number: phone_number, residence_id: residence.id)
  end
end